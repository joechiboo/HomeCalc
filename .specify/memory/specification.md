...
### 願景
打造一個簡潔、直覺的財務規劃工具，幫助使用者清楚了解房貸還款與 ETF 投資狀況，做出最佳的財務決策。
...
身為**階段性投資規劃者**，我要：
- 設定分階段的投資金額（如：現在月投 1 萬，明年 3 月後提高至 1.5 萬）
- 了解不同階段對最終報酬的影響
- 評估何時能達到財務目標
...
- **當前投資狀況**
  - ETF 選擇：0050、0056、0061、00878、00919（可複選）
  - 各 ETF 當前持有股數
  - 各 ETF 當前市價（自動更新或手動輸入）
  - 當前投資總額自動計算

- **定期定額設定**
  - 每月投入金額（預設：10,000 元）
  - 投資分配比例（可設定各 ETF 比例）
  - 預測期間：1 年、3 年、5 年、10 年

- **階段性投資設定**
  - 支援多階段投資金額變更
  - 設定變更時間點（如：2025 年 3 月）
  - 每階段的月投金額

- **報酬率假設**
  - 年化報酬率（預設：各 ETF 歷史平均值）
    - 0050: 7%
    - 0056: 6.5%
    - 0061: 8%
    - 00878: 7.5%
...
- **快速選擇預設組合**
  - 穩健型：0050 70% + 0056 30%
  - 成長型：0050 60% + 0061 40%
  - 高息型：0056 50% + 00878 30% + 00919 20%

#### 3.1.4 個人化預設值

- **使用者當前狀況**（預設值）
  - 0050: 1,600 股（約 11 萬元）
  - 0056: 137 股（約 5,000 元）
  - 當前總投資：約 11.5 萬元

- **投資策略預設**
  - 階段 1（2024/12 - 2025/03）：月投 10,000 元
  - 階段 2（2025/03 後）：月投 15,000 元
  - 預測期間：3 年
  - 股息再投入：開啟
